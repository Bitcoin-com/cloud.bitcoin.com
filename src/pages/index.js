    ...
    <Hero image={data.heroImage}>
      <HeroLayout>
        <HeroBlurbLayout>
          <H3 primary thin>
            {' '}
            Bitcoin.com Cloud Platform
          </H3>
          <H1 background>Build amazing applications</H1>
          <H3 background thin>
            Bitcoin Cash Cloud Services
          </H3>
          <HeroButtonLayout>
            <HeroButtonItem>
              <StyledLink to="/login">
                <Button round>Register or Login</Button>
              </StyledLink>
            </HeroButtonItem>
            <HeroButtonItem>
              <StyledLink to="/dashboard">
                <Button round>Dashboard</Button>
              </StyledLink>
            </HeroButtonItem>
          </HeroButtonLayout>
        </HeroBlurbLayout>
